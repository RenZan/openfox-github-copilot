...
export function getDefaultModels(): ModelConfig[] {
  return [
    ...
    { id: 'trajectory-compaction', name: 'Trajectory Compaction', contextWindow: 245760, source: 'default' },

    // Responses endpoint only
    { id: 'gpt-5.3-codex', name: 'GPT-5.3 Codex', contextWindow: 272000, source: 'default', requestBody: { endpoint: '/responses' } },
    { id: 'gpt-5.4-mini', name: 'GPT-5.4 Mini', contextWindow: 272000, source: 'default', requestBody: { endpoint: '/responses' } },
    { id: 'gpt-5.5', name: 'GPT-5.5', contextWindow: 272000, source: 'default', requestBody: { endpoint: '/responses' } },
    { id: 'gpt-5.6-luna', name: 'GPT-5.6 Luna', contextWindow: 200000, source: 'default', requestBody: { endpoint: '/responses' } },
    { id: 'gpt-5.6-sol', name: 'GPT-5.6 Sol', contextWindow: 272000, source: 'default', requestBody: { endpoint: '/responses' } },
    { id: 'gpt-5.6-terra', name: 'GPT-5.6 Terra', contextWindow: 272000, source: 'default', requestBody: { endpoint: '/responses' } },
  ]
}
